...
public class MapEdit implements ActionListener, ChangeListener, KeyListener
{
	...
	private void setupMenus()
	{
		...
		howToUse = new JMenuItem("How to use LevelEdit (N/A)");
                ...
                exportJsonMI = new JMenuItem("Export to JSON...");
		...
		howToUse.addActionListener(this);
                ...
                exportJsonMI.addActionListener(this);
	...
	public void actionPerformed(ActionEvent e) {
		...
		} else if (source == exportJsonMI) {
                    int success = chooser.showSaveDialog(mainFrame);
			if (success == JFileChooser.APPROVE_OPTION) {
				exportJson(chooser.getSelectedFile());
			}
                }
	...
	public GraphicsBank getCurrentGraphicsBank() {
        ...
        public void exportJson(File file) {
            System.err.println("Exporting to JSON as "+file);
	    ...
	    try {
			scene.saveSceneJson(file);
			mainFrame.validate();
		} catch (Exception e) {
			PromptDialog.tell("Could not save as JSON: "+e, "OK");
			e.printStackTrace();
		}
	...
	JPanel createColorDialog() {
		...
		*/
		...
		r.setToolTipText("Red channel");
                g.setToolTipText("Green channel");
                b.setToolTipText("Blue channel");
                h.setToolTipText("Hue channel");
                s.setToolTipText("Saturation channel");
