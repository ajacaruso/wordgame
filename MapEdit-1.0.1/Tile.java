...
public class Tile
{
  ...
  public Tile(int number, String path, String name, String type, WordGameProps props, String info)
  {
      this(number, path, name, type, info);
      this.props = props;
  }  
  public Tile(int number, String path, String name, String type, WordGameProps props)
  {
    this(number, path, name, type);
    this.props = props;
  }
  ...
  {
      String retMe = "";
      retMe = "\"image"+layer+"\": \""+path+"\""+
              ", \"useable"+layer+"\": "+(this.props.usable?"\"true\"":"\"false\"")+
              ", \"special"+layer+"\": \""+this.props.special.toString()+"\"";
      return retMe;
  }
